...
def ejecutar_cargar_datos() -> dict:
    ...
    avistamientos = ov.avistamientos(archivo)
...
def ejecutar_avistamientos_en_fecha(avistamientos:dict) -> None:
    ...
    """
    avistamientos = ov.avistamientos("ovnis_limpio.csv")
    fecha = input("Ingrese la fecha a buscar en formato 'YYYY-MM--DD': ")
    lista_fechas = ov.avistamientos_por_fecha(avistamientos, fecha)
...
def ejecutar_avistamientos_por_ciudad(avistamientos:dict) -> None:
    ...
    """
    avistamientos = ov.avistamientos("ovnis_limpio.csv")
    ciudades = ov.avistamientos_por_ciudad(avistamientos)
    print(ciudades)
    # TODO: complete el codigo haciendo el llamado a la funcion del modulo que
    #  implementa este requerimiento e imprimiendo por pantalla el resultado
...
def ejecutar_avistamientos_mas_de_x_segundos(avistamientos:dict) -> None:
    ...
    """
    avistamientos = ov.avistamientos("ovnis_limpio.csv")
    limite = input("Ingrese el límite inferior de la duración de un avistamiento en segundos: ")
    diccionario = ov.avistamientos_por_segundos(avistamientos, limite)
    # TODO: complete el codigo haciendo el llamado a la funcion del modulo que
    #  implementa este requerimiento e imprimiendo por pantalla el resultado
    print(diccionario)
def ejecutar_avistamientos_por_rango_de_fechas(avistamientos:dict) -> None:
    ...
    rango_fecha = ov.avistamientos_entrefechas(avistamientos, fecha_in, fecha_fin)
    print(rango_fecha)
    # TODO: complete el codigo haciendo el llamado a la funcion del modulo que
    #  implementa este requerimiento e imprimiendo por pantalla el resultado
...
def ejecutar_minimo_x_avistamientos_en_mes(avistamientos:dict) -> None:
    ...
    """
    avistamientos = ov.avistamientos("ovnis_limpio.csv")
    cantidad_minima = input("Ingrese la cantidad mínima de avistamientos a buscar: ")
    fecha = input("Ingrese el mes y año de interés, en el formato YYYY-MM:")
    se_cumplio = ov.suficientes_avistamientos(avistamientos, cantidad_minima, fecha)
    if se_cumplio == True:
...
def ejecutar_dar_avistamiento_mas_corto_y_largo_por_pais(avistamientos:dict) -> None:
    ...
    avistamientos = ov.avistamientos("ovnis_limpio.csv")
    avistamiento = ov.mayor_y_menor_duracion(avistamientos, pais)
    print(avistamiento)
    # TODO: complete el codigo haciendo el llamado a la funcion del modulo que
    #  implementa este requerimiento e imprimiendo por pantalla el resultado
...
def ejecutar_contar_avistamientos_por_forma(avistamientos:dict) -> None:
    ...
    """
    avistamientos = ov.avistamientos("ovnis_limpio.csv")
    formas = ov.avistamientos_por_forma(avistamientos)
    print(formas)
    # TODO: complete el codigo haciendo el llamado a la funcion del modulo que
    #  implementa este requerimiento e imprimiendo por pantalla el resultado
...
def ejecutar_pais_con_mas_avistamientos_de_x_segundos(avistamientos:dict) -> None:
    ...
    avistamientos = ov.avistamientos("ovnis_limpio.csv")
    limite = input("Ingrese el límite inferior de la duración de un avistamiento en segundos: ")
    diccionario = ov.avistamiento_mayor_cantidad(avistamientos, limite)
    pais = diccionario["país"]
    numero = diccionario ["avistamientos"]
    print("El país con más avistamientos que duran al menos "+ limite + " segundos es '" + pais + "', con " + str(numero) + " avistamientos")
...
def ejecutar_avistamientos_que_contengan_cadena_en_comentarios(avistamientos:dict) -> None:
    ...
    avistamientos = ov.avistamientos("ovnis_limpio.csv")
    coincidencia = ov.avistamientos_por_cadena(avistamientos, cadena)
    print(coincidencia)
